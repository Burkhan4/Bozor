  ...
  return (
    <>
      ...
      <div className="stats-grid">
        {[
          { icon: "📦", value: stats.products,   label: "Mahsulotlar",   href: "/admin/products" },
          { icon: "🏷️", value: stats.categories, label: "Kategoriyalar", href: "/admin/categories" },
          { icon: "🛒", value: stats.orders,     label: "Buyurtmalar",   href: "/admin/orders" },
          { icon: "⏳", value: stats.pending,    label: "Kutilayotgan",  href: "/admin/orders" },
      ...
      <div className="admin-card">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 }}>
          ...
          <Link href="/admin/orders" className="btn btn-secondary btn-sm">Barchasi →</Link>
        </div>
