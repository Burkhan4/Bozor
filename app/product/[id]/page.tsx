      ...
      <div className="page-container" style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            textOverflow: "ellipsis", maxWidth: 220, color: "#555",
          }}>
            {p.name}
          </span>
        </div>
        ...
        <div style={{
          ...
          <div className="product-detail-layout" style={{ display: "grid", gap: 40 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ display: "flex", gap: 2 }}>
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Star
                      key={s}
                      style={{ fontSize: 20, color: s <= stars ? "#f59e0b" : "#e5e7eb" }}
                    />
                  ))}
                </div>
              ...
              {p.description && (
                <div>
                  <p style={{ margin: "0 0 8px", fontWeight: 700, fontSize: "0.9rem", color: "#555" }}>
                    Mahsulot haqida:
                  </p>
                  <p style={{
                    margin: 0,
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={bot} style={{ textAlign: "center", flex: "1 1 80px" }}>
                    <div style={{ fontWeight: 700, color: "#16a34a", fontSize: "0.875rem" }}>{top}</div>
                    <div style={{ color: "#666", fontSize: "0.75rem" }}>{bot}</div>
                  </div>
                ))}
              </div>
